...
\lohead{\Aufgabe}
\rohead{Team-ything you put after \end{document}. It is up to you what you place there. Note also that same role plays \endinput in files include}/\pageref{LastPage}}
...
\author{\LARGE Teything you put after \end{document}. It is up to you what you place there. Note also that same role plays \endinput in files include
\maketitle
\tableofcontents
